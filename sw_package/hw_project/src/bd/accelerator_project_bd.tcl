...
# source accelerator_project.tcl
...
proc create_root_design { parentCell } {
  ...
  set block_name Accelerator
  set block_cell_name Accelerator_0
  if { [catch {set Accelerator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Accelerator_0 eq "" } {
...
CONFIG.NUM_SI {1} \
  ...
  connect_bd_net -net Accelerator_Interface_0_leds [get_bd_ports leds] [get_bd_pins Accelerator_0/leds]
  connect_bd_net -net Accelerator_Interface_0_mw_bram_din [get_bd_pins Accelerator_Interface_0/mw_bram_din] [get_bd_pins Accelerator_0/bram_din]
  connect_bd_net -net Accelerator_Interface_0_mw_bram_din_valid [get_bd_pins Accelerator_Interface_0/mw_bram_din_valid] [get_bd_pins Accelerator_0/bram_din_valid]
  connect_bd_net -net Accelerator_Interface_0_mw_bram_dout_read [get_bd_pins Accelerator_Interface_0/mw_bram_dout_read] [get_bd_pins Accelerator_0/bram_dout_read]
  connect_bd_net -net Accelerator_Interface_0_mw_clk [get_bd_pins Accelerator_Interface_0/mw_clk] [get_bd_pins Accelerator_0/clk]
  connect_bd_net -net Accelerator_Interface_0_mw_port1_din [get_bd_pins Accelerator_Interface_0/mw_port1_din] [get_bd_pins Accelerator_0/port1_din]
  connect_bd_net -net Accelerator_Interface_0_mw_port1_valid [get_bd_pins Accelerator_Interface_0/mw_port1_valid] [get_bd_pins Accelerator_0/port1_valid]
  connect_bd_net -net Accelerator_Interface_0_mw_port2_read [get_bd_pins Accelerator_Interface_0/mw_port2_read] [get_bd_pins Accelerator_0/port2_read]
  connect_bd_net -net Accelerator_Interface_0_mw_resetn [get_bd_pins Accelerator_Interface_0/mw_resetn] [get_bd_pins Accelerator_0/resetn]
  connect_bd_net -net Accelerator_0_bram_dout [get_bd_pins Accelerator_Interface_0/mw_bram_dout] [get_bd_pins Accelerator_0/bram_dout]
  connect_bd_net -net Accelerator_0_bram_dout_valid [get_bd_pins Accelerator_Interface_0/mw_bram_dout_valid] [get_bd_pins Accelerator_0/bram_dout_valid]
  connect_bd_net -net Accelerator_0_port1_read [get_bd_pins Accelerator_Interface_0/mw_port1_read] [get_bd_pins Accelerator_0/port1_read]
  connect_bd_net -net Accelerator_0_port2_valid [get_bd_pins Accelerator_Interface_0/mw_port2_valid] [get_bd_pins Accelerator_0/port2_valid]
...
preplace inst Accelerator_0 -pg 1 -lvl 2 -y 300 -defaultsOSRD
...
preplace netloc Accelerator_0_port2_valid 1 2 1 770
...
preplace netloc Accelerator_Interface_0_leds 1 2 4 NJ 410 NJ 410 NJ 410 NJ
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ
preplace netloc Accelerator_0_port1_read 1 2 1 790
preplace netloc Accelerator_0_bram_dout_valid 1 2 1 810
...
preplace netloc Accelerator_0_bram_dout 1 2 1 840
