...
CONFIG.NUM_SI {1} \
  ...
  connect_bd_net -net Accelerator_Interface_0_mw_bram_din [get_bd_pins Accelerator_Interface_0/mw_bram_din] [get_bd_pins rsa_wrapper_0/bram_din]
  connect_bd_net -net Accelerator_Interface_0_mw_bram_din_valid [get_bd_pins Accelerator_Interface_0/mw_bram_din_valid] [get_bd_pins rsa_wrapper_0/bram_din_valid]
  connect_bd_net -net Accelerator_Interface_0_mw_bram_dout_read [get_bd_pins Accelerator_Interface_0/mw_bram_dout_read] [get_bd_pins rsa_wrapper_0/bram_dout_read]
  connect_bd_net -net Accelerator_Interface_0_mw_clk [get_bd_pins Accelerator_Interface_0/mw_clk] [get_bd_pins rsa_wrapper_0/clk]
  connect_bd_net -net Accelerator_Interface_0_mw_port1_din [get_bd_pins Accelerator_Interface_0/mw_port1_din] [get_bd_pins rsa_wrapper_0/port1_din]
  connect_bd_net -net Accelerator_Interface_0_mw_port1_valid [get_bd_pins Accelerator_Interface_0/mw_port1_valid] [get_bd_pins rsa_wrapper_0/port1_valid]
  connect_bd_net -net Accelerator_Interface_0_mw_port2_read [get_bd_pins Accelerator_Interface_0/mw_port2_read] [get_bd_pins rsa_wrapper_0/port2_read]
  connect_bd_net -net Accelerator_Interface_0_mw_resetn [get_bd_pins Accelerator_Interface_0/mw_resetn] [get_bd_pins rsa_wrapper_0/resetn]
  ...
  connect_bd_net -net rsa_wrapper_0_bram_dout [get_bd_pins Accelerator_Interface_0/mw_bram_dout] [get_bd_pins rsa_wrapper_0/bram_dout]
  connect_bd_net -net rsa_wrapper_0_bram_dout_valid [get_bd_pins Accelerator_Interface_0/mw_bram_dout_valid] [get_bd_pins rsa_wrapper_0/bram_dout_valid]
  connect_bd_net -net rsa_wrapper_0_leds [get_bd_ports leds] [get_bd_pins rsa_wrapper_0/leds]
  connect_bd_net -net rsa_wrapper_0_port1_read [get_bd_pins Accelerator_Interface_0/mw_port1_read] [get_bd_pins rsa_wrapper_0/port1_read]
  connect_bd_net -net rsa_wrapper_0_port2_valid [get_bd_pins Accelerator_Interface_0/mw_port2_valid] [get_bd_pins rsa_wrapper_0/port2_valid]
...
preplace inst rsa_wrapper_0 -pg 1 -lvl 2 -y 300 -defaultsOSRD
...
preplace netloc axis_to_bram_0_bram_addr 1 2 3 860 450 NJ 450 1590
preplace netloc axis_to_bram_0_bram_we 1 2 3 850 650 NJ 650 1570
...
preplace netloc axis_to_bram_0_bram_din 1 2 3 870 460 NJ 460 1570
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 410 470 NJ 660 NJ 660 NJ 660 2040
preplace netloc rsa_wrapper_0_port1_read 1 2 1 790
preplace netloc rsa_wrapper_0_bram_dout_valid 1 2 1 810
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 740 NJ 830 NJ 830 NJ 970 NJ 970 2030
...
preplace netloc rsa_wrapper_0_port2_valid 1 2 1 770
...
preplace netloc rsa_wrapper_0_bram_dout 1 2 1 840
...
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 30 750 380 450 820 620 1260 680 1580 960 2040
...
preplace netloc rsa_wrapper_0_leds 1 2 4 NJ 410 NJ 410 NJ 410 NJ
preplace netloc Accelerator_Interface_0_mw_bram_dout_read 1 1 3 410 180 NJ 400 1270
levelinfo -pg 1 0 200 580 1060 1420 1810 2060 -top 0 -bot 980
",
}
