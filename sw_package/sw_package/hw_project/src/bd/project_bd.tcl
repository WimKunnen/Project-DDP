...
################################################################
# This is a generated script based on design: accelerator_project
#
...
# source accelerator_project_script.tcl
...
set design_name accelerator_project
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Accelerator_Interface_0, and set properties
  set Accelerator_Interface_0 [ create_bd_cell -type ip -vlnv cosic:fturan:Accelerator_Interface:1.0 Accelerator_Interface_0 ]

  # Create instance: accelerator_wrapper_0, and set properties
  set block_name accelerator_wrapper
  set block_cell_name accelerator_wrapper_0
  if { [catch {set accelerator_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $accelerator_wrapper_0 eq "" } {
...
CONFIG.NUM_MI {1} \
  ...
  # Create instance: axis_to_bram_0, and set properties
  set axis_to_bram_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_to_bram:1.0 axis_to_bram_0 ]
...
CONFIG.NUM_SI {1} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_to_bram_0/s00_axis]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins Accelerator_Interface_0/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins Accelerator_Interface_0/s01_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net Accelerator_Interface_0_mw_bram_din [get_bd_pins Accelerator_Interface_0/mw_bram_din] [get_bd_pins accelerator_wrapper_0/bram_din]
  connect_bd_net -net Accelerator_Interface_0_mw_bram_din_valid [get_bd_pins Accelerator_Interface_0/mw_bram_din_valid] [get_bd_pins accelerator_wrapper_0/bram_din_valid]
  connect_bd_net -net Accelerator_Interface_0_mw_bram_dout_read [get_bd_pins Accelerator_Interface_0/mw_bram_dout_read] [get_bd_pins accelerator_wrapper_0/bram_dout_read]
  connect_bd_net -net Accelerator_Interface_0_mw_clk [get_bd_pins Accelerator_Interface_0/mw_clk] [get_bd_pins accelerator_wrapper_0/clk]
  connect_bd_net -net Accelerator_Interface_0_mw_port1_din [get_bd_pins Accelerator_Interface_0/mw_port1_din] [get_bd_pins accelerator_wrapper_0/port1_din]
  connect_bd_net -net Accelerator_Interface_0_mw_port1_valid [get_bd_pins Accelerator_Interface_0/mw_port1_valid] [get_bd_pins accelerator_wrapper_0/port1_valid]
  connect_bd_net -net Accelerator_Interface_0_mw_port2_read [get_bd_pins Accelerator_Interface_0/mw_port2_read] [get_bd_pins accelerator_wrapper_0/port2_read]
  connect_bd_net -net Accelerator_Interface_0_mw_resetn [get_bd_pins Accelerator_Interface_0/mw_resetn] [get_bd_pins accelerator_wrapper_0/resetn]
  connect_bd_net -net accelerator_wrapper_0_bram_dout [get_bd_pins Accelerator_Interface_0/mw_bram_dout] [get_bd_pins accelerator_wrapper_0/bram_dout]
  connect_bd_net -net accelerator_wrapper_0_bram_dout_valid [get_bd_pins Accelerator_Interface_0/mw_bram_dout_valid] [get_bd_pins accelerator_wrapper_0/bram_dout_valid]
  connect_bd_net -net accelerator_wrapper_0_leds [get_bd_ports leds] [get_bd_pins accelerator_wrapper_0/leds]
  connect_bd_net -net accelerator_wrapper_0_port1_read [get_bd_pins Accelerator_Interface_0/mw_port1_read] [get_bd_pins accelerator_wrapper_0/port1_read]
  connect_bd_net -net accelerator_wrapper_0_port2_valid [get_bd_pins Accelerator_Interface_0/mw_port2_valid] [get_bd_pins accelerator_wrapper_0/port2_valid]
  connect_bd_net -net axis_to_bram_0_bram_addr [get_bd_pins Accelerator_Interface_0/bram_addr] [get_bd_pins axis_to_bram_0/bram_addr]
  connect_bd_net -net axis_to_bram_0_bram_din [get_bd_pins Accelerator_Interface_0/bram_din] [get_bd_pins axis_to_bram_0/bram_din]
  connect_bd_net -net axis_to_bram_0_bram_en [get_bd_pins Accelerator_Interface_0/bram_en] [get_bd_pins axis_to_bram_0/bram_en]
  connect_bd_net -net axis_to_bram_0_bram_we [get_bd_pins Accelerator_Interface_0/bram_we] [get_bd_pins axis_to_bram_0/bram_we]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Accelerator_Interface_0/s00_axi_aclk] [get_bd_pins Accelerator_Interface_0/s01_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axis_to_bram_0/s00_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Accelerator_Interface_0/s00_axi/axi_lite] SEG_Accelerator_Interface_0_axi_lite
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Accelerator_Interface_0/s01_axi/reg0] SEG_Accelerator_Interface_0_reg0
...
preplace inst axi_dma_0 -pg 1 -lvl 3 -y 540 -defaultsOSRD
preplace inst accelerator_wrapper_0 -pg 1 -lvl 2 -y 300 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 840 -defaultsOSRD
preplace inst axis_to_bram_0 -pg 1 -lvl 4 -y 550 -defaultsOSRD
preplace inst Accelerator_Interface_0 -pg 1 -lvl 3 -y 220 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -y 800 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 2 -y 650 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -y 810 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 5 1 NJ
preplace netloc accelerator_wrapper_0_leds 1 2 4 NJ 410 NJ 410 NJ 410 NJ
preplace netloc accelerator_wrapper_0_port1_read 1 2 1 790
preplace netloc axis_to_bram_0_bram_addr 1 2 3 850 460 NJ 460 1590
preplace netloc accelerator_wrapper_0_bram_dout 1 2 1 840
preplace netloc axis_to_bram_0_bram_we 1 2 3 860 650 NJ 650 1570
preplace netloc Accelerator_Interface_0_mw_clk 1 1 3 370 10 NJ 10 1270
preplace netloc processing_system7_0_axi_periph_M03_AXI 1 2 1 780
preplace netloc axis_to_bram_0_bram_en 1 2 3 880 640 NJ 640 1580
preplace netloc axis_to_bram_0_bram_din 1 2 3 870 450 NJ 450 1600
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 410 470 NJ 660 NJ 660 NJ 660 2050
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 740 NJ 830 NJ 830 NJ 970 NJ 970 2040
preplace netloc Accelerator_Interface_0_mw_resetn 1 1 3 380 20 NJ 20 1260
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 N
preplace netloc Accelerator_Interface_0_mw_port1_din 1 1 3 390 420 NJ 420 1260
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 2 1 760
preplace netloc Accelerator_Interface_0_mw_port1_valid 1 1 3 400 430 NJ 430 1250
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 3 400 460 830 630 1270
preplace netloc axi_dma_0_M_AXI_MM2S 1 3 1 1240
preplace netloc accelerator_wrapper_0_bram_dout_valid 1 2 1 810
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ
preplace netloc Accelerator_Interface_0_mw_bram_din_valid 1 1 3 400 40 NJ 40 1240
preplace netloc Accelerator_Interface_0_mw_port2_read 1 1 3 410 440 NJ 440 1240
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 3 410 840 NJ 840 1250
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 30 750 380 450 820 620 1260 680 1590 960 2050
preplace netloc axi_dma_0_M_AXIS_MM2S 1 3 1 N
preplace netloc Accelerator_Interface_0_mw_bram_din 1 1 3 390 30 NJ 30 1250
preplace netloc accelerator_wrapper_0_port2_valid 1 2 1 770
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 1 800
preplace netloc Accelerator_Interface_0_mw_bram_dout_read 1 1 3 410 180 NJ 400 1270
levelinfo -pg 1 0 200 580 1060 1420 1820 2070 -top 0 -bot 980
",
}
