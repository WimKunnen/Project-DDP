...
uint32_t test_asm_mul() {
	...
	asm_mont_mul_loop(a1, b1, result1, 4);
	if (compare(result1, expected1, 8) != 0) {
	...
	asm_mont_mul_loop(a2, b2, result2, 8);
	if (compare(result2, expected2, 8) != 0) {
	...
	// Third test
	uint32_t result3[64];
	uint32_t a3[32] = {0x64e226a0, 0x0b3c689c, 0xbbc4249f, 0xb6879ceb, 0xa2948140, 0x9e475301, 0xf8a4e807, 0xdeb8be1e, 0x62393ba2, 0x1d806bed, 0x0e327162, 0x9875c456, 0x5d1d1cd8, 0xca3ab936, 0xc9d00ea6, 0xfdb4eb00, 0xfdef824c, 0x556a75b4, 0x3f409f6a, 0xde267bb9, 0xac372d46, 0xc955fa8b, 0x6165627f, 0xd4ebcf2b, 0xc4346e7a, 0x3397ecec, 0xb6d49917, 0x27056bfd, 0xf7e59f92, 0x9404cfd0, 0xfa180755, 0x5063b9a7};
	uint32_t b3[32] = {0x959c0f20, 0xcce6f359, 0xba16cb19, 0xa39ee9c0, 0xdd384e8d, 0x3c45d809, 0xc70d8d03, 0x507c6875, 0x4fef0fb3, 0xd228eae1, 0x300a5a07, 0x4e07b424, 0xad22d8c7, 0x6fd4b3ec, 0x008f657c, 0x65babc37, 0xb4b366e7, 0x01fe19c2, 0x52e92488, 0x7d5124a1, 0x2d864d44, 0xae260809, 0x9c300f47, 0x0a5952a7, 0xf5db35c5, 0x6dac2a89, 0xc810cc5e, 0xa0d608a4, 0x7114d176, 0x6ff1d6bf, 0x4ecec74d, 0x872c4a4a};
	uint32_t expected3[64] = {0x86083400, 0xa8bca560, 0x75c938f4, 0x84fcbfab, 0xa3f50e65, 0xc689d831, 0xff420d28, 0x5f4e6398, 0xf58f0845, 0x2d5c85fe, 0x3d0c47d3, 0x278cc8ad, 0x8162d6a1, 0x2527fecb, 0x0991dc0c, 0xb6193f12, 0x1d9463cd, 0x0a755ee2, 0x65cc2967, 0xb8cf7da0, 0xf0fc410b, 0x45c48738, 0x18fe1536, 0xcf427929, 0x11518152, 0x4479af18, 0xeb5e88e8, 0x9789399d, 0x189c9c53, 0x51307461, 0x61168aea, 0x26271bce, 0xd36b903e, 0x2e599d94, 0x1aeca6e2, 0xaca93c9b, 0x54bb33ba, 0xeb273ce6, 0xbd7dd47e, 0xb533b71c, 0xb5057082, 0x8d64b697, 0xdf78af49, 0xd48d7185, 0x0885e39a, 0xe2d215a2, 0xbcecff22, 0x9796dcec, 0xe7073bd8, 0x96fc0401, 0x8308832b, 0x240c87a2, 0xa2806096, 0xee1b0199, 0x98b3e2e2, 0x97762b76, 0x7d553751, 0xacc10c78, 0x3041ce75, 0xb33d2b69, 0x10aed460, 0x0aab0143, 0xa6ff323f, 0x2a727f5f};
	asm_mont_mul_loop(a3, b3, result3, 32);
	if (compare(result3, expected3, 64) != 0) {
		xil_printf("Second test failed.\r\n");
		return 1;
	}
	return 0;
