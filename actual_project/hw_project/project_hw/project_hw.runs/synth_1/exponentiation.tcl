...
synth_design -top exponentiation -part xc7z010clg400-1


write_checkpoint -force -noxdef exponentiation.dcp

catch { report_utilization -file exponentiation_utilization_synth.rpt -pb exponentiation_utilization_synth.pb }
