...
set rc [catch {
  ...
  add_files -quiet /users/start2016/r0629332/Project-DDP/actual_project/hw_project/project_hw/project_hw.runs/synth_1/exponentiation.dcp
  read_xdc -unmanaged /users/start2016/r0629332/Project-DDP/actual_project/hw_project/tcl/constraints.tcl
  link_design -top exponentiation -part xc7z010clg400-1
  write_hwdef -file exponentiation.hwdef
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force exponentiation_opt.dcp
  report_drc -file exponentiation_drc_opted.rpt
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force exponentiation_placed.dcp
  report_io -file exponentiation_io_placed.rpt
  report_utilization -file exponentiation_utilization_placed.rpt -pb exponentiation_utilization_placed.pb
  report_control_sets -verbose -file exponentiation_control_sets_placed.rpt
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force exponentiation_routed.dcp
  report_drc -file exponentiation_drc_routed.rpt -pb exponentiation_drc_routed.pb
  report_timing_summary -warn_on_violation -max_paths 10 -file exponentiation_timing_summary_routed.rpt -rpx exponentiation_timing_summary_routed.rpx
  report_power -file exponentiation_power_routed.rpt -pb exponentiation_power_summary_routed.pb -rpx exponentiation_power_routed.rpx
  report_route_status -file exponentiation_route_status.rpt -pb exponentiation_route_status.pb
  report_clock_utilization -file exponentiation_clock_utilization_routed.rpt
