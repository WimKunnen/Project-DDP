...
################################################################
# This is a generated script based on design: rsa_project
#
...
# Hierarchical cell: Interface_Cell
proc create_hier_cell_Interface_Cell { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" create_hier_cell_Interface_Cell() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir O -from 31 -to 0 arm_to_fpga_cmd
  create_bd_pin -dir O arm_to_fpga_cmd_valid
  create_bd_pin -dir I arm_to_fpga_done
  create_bd_pin -dir O arm_to_fpga_done_read
  ...
  create_bd_pin -dir O -from 1023 -to 0 m_axis_tdata1
  create_bd_pin -dir I m_axis_tready1
  create_bd_pin -dir O m_axis_tvalid1
  create_bd_pin -dir O -from 0 -to 0 -type rst peripheral_aresetn
  create_bd_pin -dir I -from 1023 -to 0 s_axis_tdata1
...
CONFIG.TUSER_BITS_PER_BYTE {0} \
  ...
  # Create instance: command_interface_0, and set properties
  set command_interface_0 [ create_bd_cell -type ip -vlnv cosic:fturan:command_interface:1.0 command_interface_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins command_interface_0/s00_axi]
  ...
  connect_bd_net -net ARCACHE_dout [get_bd_pins dout1] [get_bd_pins ARCACHE/dout]
  connect_bd_net -net ARUSER_dout [get_bd_pins dout] [get_bd_pins ARUSER/dout]
  connect_bd_net -net arm_to_fpga_done_1 [get_bd_pins arm_to_fpga_done] [get_bd_pins command_interface_0/arm_to_fpga_done]
  connect_bd_net -net axis_dwidth_converter_0_m_axis_tdata [get_bd_pins m_axis_tdata1] [get_bd_pins axis_dwidth_converter_0/m_axis_tdata]
  connect_bd_net -net axis_dwidth_converter_0_m_axis_tvalid [get_bd_pins m_axis_tvalid1] [get_bd_pins axis_dwidth_converter_0/m_axis_tvalid]
  connect_bd_net -net axis_dwidth_converter_1_s_axis_tready [get_bd_pins s_axis_tready1] [get_bd_pins axis_dwidth_converter_1/s_axis_tready]
  connect_bd_net -net command_interface_0_arm_to_fpga_cmd [get_bd_pins arm_to_fpga_cmd] [get_bd_pins command_interface_0/arm_to_fpga_cmd]
  connect_bd_net -net command_interface_0_arm_to_fpga_cmd_valid [get_bd_pins arm_to_fpga_cmd_valid] [get_bd_pins command_interface_0/arm_to_fpga_cmd_valid]
  connect_bd_net -net command_interface_0_arm_to_fpga_done_read [get_bd_pins arm_to_fpga_done_read] [get_bd_pins command_interface_0/arm_to_fpga_done_read]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins ext_reset_in] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net m_axi_mm2s_aclk_1 [get_bd_pins m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins command_interface_0/s00_axi_aclk] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net m_axis_tready1_1 [get_bd_pins m_axis_tready1] [get_bd_pins axis_dwidth_converter_0/m_axis_tready]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins command_interface_0/s00_axi_aresetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net s_axis_tdata1_1 [get_bd_pins s_axis_tdata1] [get_bd_pins axis_dwidth_converter_1/s_axis_tdata]
  connect_bd_net -net s_axis_tvalid1_1 [get_bd_pins s_axis_tvalid1] [get_bd_pins axis_dwidth_converter_1/s_axis_tvalid]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axis_dwidth_converter_1/s_axis_tlast] [get_bd_pins xlconstant_0/dout]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Interface_Cell
  create_hier_cell_Interface_Cell [current_bd_instance .] Interface_Cell
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: rsa_wrapper_0, and set properties
  set block_name rsa_wrapper
  set block_cell_name rsa_wrapper_0
  if { [catch {set rsa_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rsa_wrapper_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net Interface_Cell_M00_AXI [get_bd_intf_pins Interface_Cell/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_ACP]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins Interface_Cell/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net ARCACHE_dout [get_bd_pins Interface_Cell/dout1] [get_bd_pins processing_system7_0/S_AXI_ACP_ARCACHE] [get_bd_pins processing_system7_0/S_AXI_ACP_AWCACHE]
  connect_bd_net -net Interface_Cell_arm_to_fpga_cmd [get_bd_pins Interface_Cell/arm_to_fpga_cmd] [get_bd_pins rsa_wrapper_0/arm_to_fpga_cmd]
  connect_bd_net -net Interface_Cell_arm_to_fpga_cmd_valid [get_bd_pins Interface_Cell/arm_to_fpga_cmd_valid] [get_bd_pins rsa_wrapper_0/arm_to_fpga_cmd_valid]
  connect_bd_net -net Interface_Cell_arm_to_fpga_done_read [get_bd_pins Interface_Cell/arm_to_fpga_done_read] [get_bd_pins rsa_wrapper_0/arm_to_fpga_done_read]
  connect_bd_net -net Interface_Cell_m_axis_tdata1 [get_bd_pins Interface_Cell/m_axis_tdata1] [get_bd_pins rsa_wrapper_0/arm_to_fpga_data]
  connect_bd_net -net Interface_Cell_m_axis_tvalid1 [get_bd_pins Interface_Cell/m_axis_tvalid1] [get_bd_pins rsa_wrapper_0/arm_to_fpga_data_valid]
  connect_bd_net -net Interface_Cell_peripheral_aresetn [get_bd_pins Interface_Cell/peripheral_aresetn] [get_bd_pins rsa_wrapper_0/resetn]
  connect_bd_net -net Interface_Cell_s_axis_tready1 [get_bd_pins Interface_Cell/s_axis_tready1] [get_bd_pins rsa_wrapper_0/fpga_to_arm_data_ready]
  connect_bd_net -net m_axis_tready1_1 [get_bd_pins Interface_Cell/m_axis_tready1] [get_bd_pins rsa_wrapper_0/arm_to_fpga_data_ready]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Interface_Cell/m_axi_mm2s_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins rsa_wrapper_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins Interface_Cell/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net rsa_wrapper_0_arm_to_fpga_done [get_bd_pins Interface_Cell/arm_to_fpga_done] [get_bd_pins rsa_wrapper_0/arm_to_fpga_done]
  connect_bd_net -net rsa_wrapper_0_leds [get_bd_ports leds] [get_bd_pins rsa_wrapper_0/leds]
  connect_bd_net -net s_axis_tdata1_1 [get_bd_pins Interface_Cell/s_axis_tdata1] [get_bd_pins rsa_wrapper_0/fpga_to_arm_data]
  connect_bd_net -net s_axis_tvalid1_1 [get_bd_pins Interface_Cell/s_axis_tvalid1] [get_bd_pins rsa_wrapper_0/fpga_to_arm_data_valid]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins Interface_Cell/dout] [get_bd_pins processing_system7_0/S_AXI_ACP_ARUSER] [get_bd_pins processing_system7_0/S_AXI_ACP_AWUSER]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Interface_Cell/axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Interface_Cell/command_interface_0/s00_axi/axi_lite] SEG_command_interface_0_axi_lite
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces Interface_Cell/axi_dma_0/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces Interface_Cell/axi_dma_0/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces Interface_Cell/axi_dma_0/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_processing_system7_0_ACP_QSPI_LINEAR
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces Interface_Cell/axi_dma_0/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_processing_system7_0_ACP_QSPI_LINEAR

  # Exclude Address Segments
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces Interface_Cell/axi_dma_0/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP] SEG_processing_system7_0_ACP_IOP
  exclude_bd_addr_seg [get_bd_addr_segs Interface_Cell/axi_dma_0/Data_MM2S/SEG_processing_system7_0_ACP_IOP]

  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces Interface_Cell/axi_dma_0/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP0] SEG_processing_system7_0_ACP_M_AXI_GP0
  exclude_bd_addr_seg [get_bd_addr_segs Interface_Cell/axi_dma_0/Data_MM2S/SEG_processing_system7_0_ACP_M_AXI_GP0]

  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces Interface_Cell/axi_dma_0/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP] SEG_processing_system7_0_ACP_IOP
  exclude_bd_addr_seg [get_bd_addr_segs Interface_Cell/axi_dma_0/Data_S2MM/SEG_processing_system7_0_ACP_IOP]

  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces Interface_Cell/axi_dma_0/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP0] SEG_processing_system7_0_ACP_M_AXI_GP0
  exclude_bd_addr_seg [get_bd_addr_segs Interface_Cell/axi_dma_0/Data_S2MM/SEG_processing_system7_0_ACP_M_AXI_GP0]
...
preplace portBus leds -pg 1 -y 340 -defaultsOSRD
preplace inst rsa_wrapper_0 -pg 1 -lvl 1 -y 220 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 3 -y 150 -defaultsOSRD
preplace inst Interface_Cell -pg 1 -lvl 2 -y 170 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 3 1 NJ
preplace netloc xlconstant_1_dout 1 2 1 1160
preplace netloc Interface_Cell_m_axis_tdata1 1 0 3 60 360 NJ 360 1120
preplace netloc Interface_Cell_arm_to_fpga_done_read 1 0 3 40 20 NJ 20 1140
preplace netloc Interface_Cell_arm_to_fpga_cmd_valid 1 0 3 50 350 NJ 350 1130
preplace netloc s_axis_tdata1_1 1 1 1 530
preplace netloc processing_system7_0_M_AXI_GP0 1 1 3 540 330 NJ 330 1690
preplace netloc Interface_Cell_peripheral_aresetn 1 0 3 20 380 NJ 380 1100
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 3 550 320 NJ 320 1670
preplace netloc s_axis_tvalid1_1 1 1 1 510
preplace netloc Interface_Cell_M00_AXI 1 2 1 1160
preplace netloc rsa_wrapper_0_arm_to_fpga_done 1 1 1 510
preplace netloc Interface_Cell_m_axis_tvalid1 1 0 3 30 370 NJ 370 1110
preplace netloc ARCACHE_dout 1 2 1 1150
preplace netloc processing_system7_0_FIXED_IO 1 3 1 NJ
preplace netloc Interface_Cell_arm_to_fpga_cmd 1 0 3 30 10 NJ 10 1150
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 50 100 520 310 1150 300 1680
preplace netloc m_axis_tready1_1 1 1 1 510
preplace netloc rsa_wrapper_0_leds 1 1 3 NJ 340 NJ 340 NJ
preplace netloc Interface_Cell_s_axis_tready1 1 0 3 40 390 NJ 390 1090
levelinfo -pg 1 0 300 910 1428 1710 -top 0 -bot 400
",
}
